...
<main className="projectmain">
   <h2>My Portfolio</h2>
    ...
    <div className="project">
        <a target="_blank" href="https://comments-section-orcin.vercel.app/" ><img className="screenshots" alt="comments" src="/PICS/comments.png"  /></a>
        <div className="projectdes">
        <h4>Comments Section Component</h4>
        <p>
            An interactive Comments section component with CRUD capabilities.
        </p>
        <p>
            Built with <a target="_blank" href='https://react.dev/'><b>React</b></a> and <a target="_blank" href='https://en.wikipedia.org/wiki/CSS'><b>CSS</b></a>
        </p>
        <p><b><a target="_blank" href="https://comments-section-orcin.vercel.app/">Live site<RxExternalLink className="exlink" /></a></b>&nbsp; <b><a target="_blank" href='https://github.com/AnosVoldigoad999/comments-section.git'><AiFillGithub className='github' />Github</a></b></p>
        </div>
    </div>
    <div className="project">
